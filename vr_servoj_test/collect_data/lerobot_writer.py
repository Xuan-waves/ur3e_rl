...
from .config import VrServoJCollectConfig
...
class LeRobotVrServoJWriter:
    def __init__(self, cfg: VrServoJCollectConfig):
        self.cfg = cfg
        self.dataset = None
    ...
    def _state_names(self) -> list[str]:
        if self.cfg.state_mode == "jointspace":
            return ["q1", "q2", "q3", "q4", "q5", "q6", "gripper", "RL_mark"]
        return ["tcp_x", "tcp_y", "tcp_z", "tcp_rx", "tcp_ry", "tcp_rz", "gripper", "RL_mark"]
    ...
    def _action_names(self) -> list[str]:
        ...
        if self.cfg.ee_action_position_mode == "relative":
            pos = ["delta_tcp_x", "delta_tcp_y", "delta_tcp_z"]
        else:
            pos = ["target_tcp_x", "target_tcp_y", "target_tcp_z"]
        return pos + ["target_tcp_rx", "target_tcp_ry", "target_tcp_rz", "target_gripper", "RL_mark"]
